...
The relation seems to non-linear, as the scatterplot depict a curved shaped best-fit line.
...
plot_line(theta)
# theta   <- GDA(x, y, theta0, alpha = 0.095, epsilon = 1e-8)
# plot_line(theta)
```
...
2. Compare BGD and SGD.
  - Run both codes: Set theta = c(1, -1), alpha = 0.005, epsilon = 1e-5, and max_iter = 10.
